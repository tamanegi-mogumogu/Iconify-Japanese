...
public class HeaderClockStyles {
    ...
    public static ViewGroup getClock(Context mContext) {
        ...
        if (showHeaderClock) {
            ...
            int accentPrimary = ResourcesCompat.getColor(mContext.getResources(), isPixelVariant ? android.R.color.holo_green_light : android.R.color.holo_blue_light, mContext.getTheme());
            int accentSecondary = ResourcesCompat.getColor(mContext.getResources(), isPixelVariant ? android.R.color.holo_green_dark : android.R.color.holo_blue_dark, mContext.getTheme());
            ...
            switch (headerClockStyle) {
                ...
                case 6 -> {
                    ...
                    GradientDrawable mDrawable61 = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{0xFF3473B8, 0xFF3473B8});
                    ...
                    GradientDrawable mDrawable62 = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{0xFF38AA4A, 0xFF38AA4A});
                    ...
                    GradientDrawable mDrawable63 = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{0xFFFEBF32, 0xFFFEBF32});
                    ...
                    GradientDrawable mDrawable64 = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{0xFFE33830, 0xFFE33830});

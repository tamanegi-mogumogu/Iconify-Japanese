...
public class Const {
    ...
    // Github repo
    public static final String GITHUB_REPO = "https://github.com/tamanegi-mogumogu/Iconify-Japanese";

    // Telegram group
    public static final String TELEGRAM_GROUP = "https://t.me/IconifyDiscussion";

    // Parse new update
    public static final String LATEST_VERSION = "https://raw.githubusercontent.com/tamanegi-mogumogu/Iconify-Japanese/stable/latestVersion.json";

    // Parse changelogs
    public static final String CHANGELOG_URL = "https://api.github.com/repos/tamanegi-mogumogu/Iconify-Japanese/releases/tags/v";

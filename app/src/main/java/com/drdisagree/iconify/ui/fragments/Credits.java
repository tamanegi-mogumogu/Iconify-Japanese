...
public class Credits extends BaseFragment {
    ...
    private InfoAdapter initTranslatorsList() {
        ...
        translators_list.add(new InfoModel(requireContext(), "tqmane", Iconify.getAppContextLocale().getResources().getString(R.string.ja_translation), "https://github.com/tqmane", R.drawable.ic_user));
